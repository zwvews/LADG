...
def main():
    config_ours = dict(
        dataset='poverty',  # [poverty, camelyon17, iwildcam, civilcomments,amazon, fmow, rxrx1]
        algorithm='ladg',
        warmupFeaSteps=200,
        warmupDiscSteps=100,
    ...
    config = edict(
        algo_log_metric=None, algorithm='ladg', batch_size=None, coral_penalty_weight=None, dataset=dataset,
